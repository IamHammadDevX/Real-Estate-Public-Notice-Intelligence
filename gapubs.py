# -*- coding: utf-8 -*-
"""
GA Public Notices — combined scraper + Propstream enrichment.
Produces one CSV + XLSX per run: exports/GaCombined_<timestamp>.csv/xlsx
"""
...
def main(limit=None):
    ...
    if combined:
        ...
        csv_path = os.path.join(out_dir, f'GaCombined_{ts}.csv')
        ...
        try:
            ...
            xlsx_path = os.path.join(out_dir, f'GaCombined_{ts}.xlsx')
    ...
    if strict_run and (scrape_error or scrape_failures or propstream_failures):
        raise RuntimeError(
            "Incomplete GA run: scrape_error={}, failed_notices={}, "
